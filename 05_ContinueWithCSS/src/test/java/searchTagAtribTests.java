...
public class searchTagAtribTests {
    ...
    public void searchTagAttribTest1()
    {
        ...
        var locator14 = driver.findElements(By.cssSelector("div[class='book-price']")); //Локатор на главной странице для элемента <div class="book-price">. Осуществите поиск одновременно по тегу и классу, равному book-price.
        ...
        var locator21 = driver.findElements(By.cssSelector("footer[id='footer'] > div")); // На главной странице найдите все теги div, которые являются дочерними элементами первого уровня у элемента <footer id="footer">.
        var locator22 = driver.findElement(By.cssSelector("li[id='genres'] + *")); //На главной странице найдите любой тег, который расположен сразу после <li id="genres">.
    ...
    public void searchTagAttribTest3()
    {
        ...
        var locator32 = driver.findElement(By.cssSelector("form.form[id='login-form'] > *:last-child")); //Последний тег p, находящийся сразу на первом уровне вложенности внутри <form class="form" id="login-form">. Используйте поиск по child.
